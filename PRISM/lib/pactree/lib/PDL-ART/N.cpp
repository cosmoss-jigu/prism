...
//	if(isLeaf)
//	tmp+=(uint64_t)((uint64_t)1<<63);

	lockGenId = (version - tmp)>>32;
/*	if(lockGenId!=3){
	    printf("0: version :%lu tmp :%lu, lockGenId:%u\n",version,tmp,lockGenId);
		}*/
