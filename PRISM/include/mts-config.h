...
#define MTS_OPLOG_G_SIZE (64UL * 1UL * 1024UL * 1024UL)
...
#define MTS_VS_G_SIZE (MTS_VS_NUM * 96UL * 1024UL * 1024UL * 1024UL)
...
#define MTS_DRAMCACHE_SIZE ((64UL * 1UL * 1024UL * 1024UL))
