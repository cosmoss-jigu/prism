...
RESULT_DIR="${CURRENT_DIR}/result/figure15"		    #Results go this directory.
...
WORKLOAD_TYPE=(a c e)   #Typing which workload_type will be tested.
CORE_NUM=(10 20 30 40)		    #how many CPU cores?    ##PRISM threads: CPU cores / 5 * 4 ##IO Completion threads: CPU cores * 5
