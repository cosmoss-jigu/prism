...
RESULT_DIR="${CURRENT_DIR}/result/figure11"		    #Results go this directory.
...
WORKLOAD_TYPE=(f)   #Typing which workload_type will be tested.
CORE_NUM=(40)		    #how many CPU cores?    ##PRISM threads: CPU cores / 5 * 4 ##IO Completion threads: CPU cores * 5
ZIPF=("0.5" "0.99" "1.2")		    #Zipfian coefficient
...
KV_SIZE=(512 1024)	    #512 2048 4096
PERF_MODE=(0)	    
