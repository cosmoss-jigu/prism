...
RESULT_DIR="${CURRENT_DIR}/result/figure12"		    #Results go this directory.
...
WORKLOAD_TYPE=(a c)   #Typing which workload_type will be tested.
...
DISK_NUM=(1 2 4 8)	    #The number of SSDs
